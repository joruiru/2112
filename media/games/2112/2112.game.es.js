...
undum.game.situations = {
    ...
    pintro10: new undum.SimpleSituation(
        ...
        <p>&#8212;Predice el intento de asesitano de Juan Pablo II.</p>\
        ...
        tres veces, una ciudad destruida y sus calles y sus siete colinas llenas de\
        ...
        en 1929. &#8212;Sus nudosos dedos desplegaron sobre el escritorio un pergamino medieval.</p>\
        ...
        <p>El Santo Padre recordó el capítulo sexto del Génesis, en el que se decía que\
        ...
        a ellos y a toda la raza humana, con el Gran Diluvio. Salvo a Noé y su familia.\
        Sin embargo, Paola también recordaba que ni las visiones apocalípticas de la\
        Biblia ni las que habían relatado los pastorcillos portugueses detallaban el\
        futuro con demasiada precisión. Al contrario, lo resumían y lo situaban sobre\
        un escenario atemporal y unificado, plagado de símbolos que precisaban de interpretación.</p>\
        <p><br/></p>\
        <p class='transient'><a href='pintro9/si' class='once'>&gt; Sí.</a></p>\
        <p class='transient'><a href='pintro9/no' class='once'>&gt; No.</a></p>"
    ),
